...
* botany 
* field work 
* participatory workshops in sustainability projects for Afghanistan 
* developed M&E plans for DEFRA funded sustainability projects
...
* supervised several undergrad & masters students on open source research software ['riboviz'](https://github.com/riboviz/riboviz) project
* outreach projects such as [4273pi](https://4273pi.org/) projects getting bioinformatics into Scottish schools 
* love community events - CERSE, EdinbR, ReproducibiliTea, R-Ladies, WomenWhoCode, Data Fest, RstudioGlobal, Turing Fest, SSI Collaborations Workshops...
</div>
...
* I spend my time thinking about how to improve research software, and how much of the answer might be about people... 
...
* How do we ensure that good software practices and research practices are available to support the growing need?
...
## Map the Scottish RSEcosystem 

PROBLEM: difficult to identify relevant groups which help RSEs get the skills and development they need and join local communities of best practice... Once you find them, they might not be active.

SOLUTION: fellowship will identify and map active RSE-related groups and organisations using stakeholder analysis and put together a curated list of groups which are key in supporting sustainable software in research. These groups will be invited to join the "Scottish RSEcosystem Network".
...
PROBLEM: RSE-relevant groups and organisations often find it difficult to keep track of each other's organisers, or may not know about similarly oriented groups. This makes cooperation to solve common challenges difficult.

SOLUTION: fellowship will invite selected organisations and groups to become part of the "Scottish RSEcosystem" network, with a networking event run to connect group organisers and facilitate opportunities to collaborate and celebrate their contributions to their specific communities and the area of Research Software.
...
Determining whether the network will be dissolved, or groups wish to continue it in some format will occur in month 13, with an election and handover process running from months 14 to 15. 
...
## Investigate Scottish RSEcosystem Challenges 
...
The findings of both workshops will be reported to all selected groups, whether or not they engaged in the participatory workshops to spread best practices ideas. 
...
```{r, out.width = "700"}
knitr::include_graphics("https://raw.githubusercontent.com/FlicAnderson/ssi-fellowship-application-slides/main/images/SSI_fellowship_ScottishRSEcosystemWorkplan.png?token=GHSAT0AAAAAABRDS2HFX7D23MXHGKEHSG54YZ26R3A")
```  
...
<div style="float: left; width: 30%;">
```{r, out.width = "300"}
knitr::include_graphics("https://raw.githubusercontent.com/FlicAnderson/ssi-fellowship-application-slides/main/images/SSI_fellowship_ScottishRSEcosystemCosts.png?token=GHSAT0AAAAAABRDS2HFZJPHA6M3NLILZ5V6YZ26REA")
```  
